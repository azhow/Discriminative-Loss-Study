...
if __name__ == "__main__":
    ...
    parser.add_argument('--experiment_folder', type=str, help="Folder containing the experiments")
    args = parser.parse_args()
    
    gt_json = os.path.join(args.experiment_folder, "After\\gts\\converted.json")
    pred_json = os.path.join(args.experiment_folder, "After\\predictions\\converted.json")
    gt_folder = os.path.join(args.experiment_folder, "After\\gts\\images\\")
    pred_folder = os.path.join(args.experiment_folder, "After\\predictions\\images\\")
    pq_compute(gt_json, pred_json, gt_folder, pred_folder)